...
public class IotLuaXtextValidatorConfigurationBlock extends AbstractValidatorConfigurationBlock {

	@Override
	protected void fillSettingsPage(Composite composite, int nColumns, int defaultIndent) {
		addComboBox(IotLuaXtextConfigurableIssueCodesProvider.DEPRECATED_MODEL_PART, "Deprecated Model Part", composite, defaultIndent);
	}
	...
	protected IDialogSettings getDialogSettings() {
		...
		IDialogSettings section = dialogSettings.getSection("IotLuaXtext");
		if (section == null) {
			return dialogSettings.addNewSection("IotLuaXtext");
		}
		return section;
	}
}
